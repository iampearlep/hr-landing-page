  ...
  return (
    <div className="py-10 md:py-14 mx-auto w-11/12 md:w-10/12">
      <div className="flex flex-col md:flex-row gap-x-10 gap-y-10 justify-center px-6">
        <div className="w-full md:w-1/2 flex flex-col py-4 md:py-12 gap-y-5">
        ...
        <button className="bg-blue-200 px-2 py-2 rounded-full font-semibold w-2/5 md:w-[25%]">Get Started</button>
        </div>
